...
// generated ids). The queries live next to this file, one file per table group (note.go, user.go,
// session.go).
package mysql
...
// errDuplicateEntry is MySQL's ER_DUP_ENTRY error number — raised when a UNIQUE constraint is
// violated.
