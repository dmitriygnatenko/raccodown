...
func (m *MockStorage) CreateUser(ctx context.Context, username, passwordHash string, createdAt, updatedAt time.Time) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUser", ctx, username, passwordHash, createdAt, updatedAt)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStorageMockRecorder) CreateUser(ctx, username, passwordHash, createdAt, updatedAt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateUser", reflect.TypeOf((*MockStorage)(nil).CreateUser), ctx, username, passwordHash, createdAt, updatedAt)
}
...
func (m *MockStorage) GetUserSettings(ctx context.Context, id uint64) (model.UserSettings, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserSettings", ctx, id)
...
func (mr *MockStorageMockRecorder) GetUserSettings(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStorage) UpdateUserSettings(ctx context.Context, id uint64, settings model.UserSettings, updatedAt time.Time) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserSettings", ctx, id, settings, updatedAt)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
