...
// initLogger installs the process-wide structured logger (via slog.SetDefault) that use cases and
// the HTTP adapter call through the package-level slog.ErrorContext etc. to record operational
// events.
//
